                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Spacer(),
                        Icon(Icons.more_vert_outlined,size: 24,color: Colors.white,),
                        SizedBox(
                          width: 10.w,
                        )
                      ],
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: Icon(Icons.calendar_month,size: 27,color: Colors.white,),
                          ),
                          SizedBox(width: 12.w,),
                          Column(
                            children: [
                          ...
                          IconButton(
                            onPressed: (){
                              ...
                              icon: Icon(Icons.expand_circle_down_rounded,size: 24,color: Colors.white,))
                        ],
                      ),
                    )
                  ],
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text("Performence",style: TextStyle(
                    fontSize: 21,
                    fontWeight: FontWeight.w600,
                    fontFamily: "Inter",
                  ),),
                        ...
                        leftTitles:  AxisTitles(
                          sideTitles: SideTitles(
                            ...
                            final Container  con;
                              switch (value.toInt()){
                                case 1:
                                con=Container(height: 45,width: 45,child: Image.asset("assets/graph_emoji/joyf.png"));
                                case 2:
                                  con=Container(height: 40,width: 40,child: Image.asset("assets/graph_emoji/smilef.png"));
                                case 3:
                                  con=Container(height: 42,width: 42,child: Image.asset("assets/graph_emoji/surprisedf.png"));
                                case 4:
                                  con=Container(height: 39,width: 39,child: Image.asset("assets/graph_emoji/sadf.png"));
                                case 5:
                                  con=Container(height: 30,width: 30,child: Image.asset("assets/graph_emoji/fearf.png"));
                                case 6:
                                  con=Container(child: Image.asset("assets/graph_emoji/angryf.png"));
                                default:
                                  return Container();
                              }
                        ...
                        LineChartBarData(
                          spots: List.generate(
                            selectedProduction.length,
                                (index) => FlSpot(index.toDouble(), selectedProduction[index]),
                          ),
                          isCurved: true,
                          gradient: LinearGradient(colors:[Color(0xffF10086),
                            Color(0xff3F00F1)] ),
                          color: Colors.blue,
                          ...
                          gradient: LinearGradient(
                              ...
                              colors: [Color(0xffF10086).withOpacity(0.80),
                ...
                Container(
                  ...
                  child: DropdownButton<String>(
                    value: _selectedItem,
                    items: ['Last 7 Days', 'Last Month', 'Last 3 Months', 'Last 6 months','Last year','Total Performence']
                        .map((String item) {
