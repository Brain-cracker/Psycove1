...
class AppColors {
  final main = Color(0xffD3A3F1);
  final shadow = Color(0xff803a9f);
  final H1 = Color(0xff000000);
  final H2 = Color(0xffFFFFFF);
  final H3 = Color(0xff606060);
  final lebelSmall = Color(0xff677294);
  final Boxtext = Color(0xff797C7B);
  final mainshadow = Color(0xffD3A3F1).withOpacity(0.20);
  final background = Color(0xffF4F4F4);
