...
import 'package:atman_2/pages/data_privacy.dart';
                    ...
                    children: [
                      InkWell(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => PsychologisstSearch())
                          );
                          print('Button tapped!');
                        },
                        child: Container(
                            ...
                            Container(
                              child: InkWell(
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(builder: (context) => MessageCentre()),
                                  );
                                  print('Button tapped!');
                                },
                                child: Container(
                            ...
                            Container(
                              child: InkWell(
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(builder: (context) => MyPerformence()),
                                  );
                                  print('Button tapped!');
                                },
                                child: Container(
